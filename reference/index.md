...
## Parts of a fitted model

The pieces of a fit, laid out by name for code built on it: its random
effects, its variance components, the cells of a correlation over time,
and the quadrature behind a population average.

- [`ilm_ranef()`](https://huttoncp.github.io/illume/reference/ilm_ranef.md)
  [`ranef(`*`<ilm_model>`*`)`](https://huttoncp.github.io/illume/reference/ilm_ranef.md)
  [`as.data.frame(`*`<ilm_ranef>`*`)`](https://huttoncp.github.io/illume/reference/ilm_ranef.md)
