...
The **multinomial** family closes a specific hole. If an outcome has three or
more categories with no natural order -- a diagnosis, a habitat type, a choice
among options -- and the data are grouped, R has had no good frequentist
...
`vignette("workflow")` is the map: ten stages from power to scenario, with a
pointer for each.
