...
**And one predecessor.** The exploratory half of this package is a
direct descendant of [`elucidate`](https://github.com/bcgov/elucidate),
written by the same author for the BC Public Service. The lineage is
...
reassembled from memory every time. `illume` reimplements that on a
