...
Descriptive statistics, plots, and bootstrap intervals for the
quantities you are about to model.
...
[`vignette("anova")`](https://craig-hutton.github.io/illume/articles/anova.md).
...
| *Anomaly detection* | [`ilm_anomaly()`](https://craig-hutton.github.io/illume/reference/ilm_anomaly.md) against [`ilm_outliers()`](https://craig-hutton.github.io/illume/reference/ilm_outliers.md) |
| *Missing data* | diagnosing it, imputing it, pooling |
| *Causal models* | DAGs, difference-in-differences, discontinuities |
| *Effect size and power* | [`ilm_effects()`](https://craig-hutton.github.io/illume/reference/ilm_effects.md), [`ilm_power()`](https://craig-hutton.github.io/illume/reference/ilm_power.md), [`ilm_scenario()`](https://craig-hutton.github.io/illume/reference/ilm_scenario.md) |
