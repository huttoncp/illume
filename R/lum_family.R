...
#' University Press.
#' @examples
#' lum_family("poisson")$n_disp      # Poisson has no dispersion parameter
#' lum_family("nbinom")$disp_names
#' @export
lum_family <- function(family = c("gaussian", "binomial", "poisson",
                                  "nbinom", "multinomial")) {
...
#' @param family A family object from [lum_family()].
#' @return `TRUE`, invisibly; called for its error messages.
#' @keywords internal
#' @noRd
lum_check_response <- function(y, family) {
  nm <- family$name
